...
namespace putslam {
    ...
    class Graph {
        public:
            ...
            virtual bool optimizeAndPrune(double threshold, unsigned int singleIteration, int verbose = 0) = 0;

            /// Removes weak edes (with error bigger than threshold
            virtual bool optimizeAndPrune2(double threshold, unsigned int singleIteration, int verbose = 0) = 0;
